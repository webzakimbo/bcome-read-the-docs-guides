...
Below can be seen a simple network configuration that sets populate a single Inventory with all running instances within the 'eu-west-1' region of the linked AWS account.
